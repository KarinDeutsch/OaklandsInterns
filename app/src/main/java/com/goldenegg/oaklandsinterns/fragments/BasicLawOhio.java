...
public class BasicLawOhio  extends AppCompatActivity {
    Button btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(v -> startActivity(new Intent(BasicLawOhio.this, MainActivity.class)));
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(BasicLawOhio.this, LawsRulesActivity.class);
