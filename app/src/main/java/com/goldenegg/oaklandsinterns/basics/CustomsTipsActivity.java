...
public class CustomsTipsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageViewLogo.setOnClickListener(v ->
                startActivity(new Intent(CustomsTipsActivity.this, MainActivity.class))
        );

        // Back button – go to BasicsActivity
        ImageView imageViewBack = findViewById(R.id.btnBack);
        imageViewBack.setOnClickListener(v ->
                startActivity(new Intent(CustomsTipsActivity.this, BasicsActivity.class))
        );
    }
}